...
public class FaceCheck {
	private static Mat dobj(Mat src){
		...
		CascadeClassifier detector=new CascadeClassifier("resources/haarcascade_frontalface_alt.xml");
	...
	public static void main(String[] args) {
		try{
			...
			Mat src=Imgcodecs.imread("./images/test.jpg");
			if(!src.empty()){
				Mat dst=dobj(src);
				Imgcodecs.imwrite("./images/finish.jpg", dst);
			}
		}catch(Exception e){
			e.printStackTrace();
		}
